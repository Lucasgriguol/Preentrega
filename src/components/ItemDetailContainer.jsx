...
const ItemDetailContainer = () => {
  ...
  const fetchItemDetails = async (itemId) => {
    ...
    const allItems = [
      ...
      { id: 15, name: 'Brick and Motor', category: '3', price: 4500, description: 'Edición especial diseñada con detalles industriales, una combinación de arte y rendimiento. Este modelo es perfecto para quienes buscan algo diferente en el mundo de Hot Wheels.', image: '/images/especial motor.webp' },
